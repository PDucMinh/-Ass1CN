...
CFG = {
    ...
    "constants": {
        ...
        "MAX_TCP_SEGMENT_DATA_SIZE": 65527,
        "BUFFER_SIZE": 9216,        # MACOSX TCP MTU is 9216
        "CHUNK_PIECES_SIZE": 9216 - 2000, # Each chunk pieces(segments of TCP) must be lower than TCP buffer size
